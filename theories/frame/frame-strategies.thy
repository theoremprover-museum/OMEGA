...
(strat~define-strategy-ks
 ...
 (selection waterfall)
 (print "Strategy-KS Homo-Assoc ~A"))
...
(defmethod print-object ((strategy-ks strat+strategy-ks) stream)
  (format stream "><Strategy-ks ~A for Refinement Algorithm"
...
;		 prefer-non-mv-tasks
 ...
 (termination-check (lambda () nil))
 (selection waterfall)
 (print "Strategy-KS Fomo ~A"))



;multi (fomo ) (defer-already-applied-strategies reject-instjob ) t 10
;multi (homo ) (defer-already-applied-strategies reject-instjob ) t 10
