OMEGA-BASIC EXPAND-NODE (l20)
OMEGA-BASIC LEMMA default ((INT 2))
TACTICS WELLSORTED (l25) default
EXTERN CALL-OTTER-ON-NODE (l20) default default default default default default default default default default default default default default

OMEGA-BASIC EXPAND-NODE (l13)
TACTICS BY-COMPUTATION (L13) ((l11))
	
OMEGA-BASIC EXPAND-NODE (l21)
TACTICS BY-COMPUTATION (L21) ((l19 l13))
...
TACTICS DEFN-CONTRACT-NUMS (l63) nil
...
EXTERN CALL-OTTER-ON-NODE (l103) default default default default default default default default default default default default default default
